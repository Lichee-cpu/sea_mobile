 ...
 * @LastEditors: lxiang
 * @LastEditTime: 2023-04-23 09:27:54
 * @description: 跟踪时间对象
 * @FilePath: \sea_mobile\src\views\threejs\demo\f.vue
-->
<template>
  <div class="info">
...
export default {
  ...
  setup() {
    ...
    const draw = () => {
      ...
      function animate() {
        let time = clock.getElapsedTime(); // 获取从开始到现在所用的时间
        // let deltaTime = clock.getDelta(); // 获取从上一帧到现在的时间
        let t = time % 5; // 除以1000是为了将毫秒转换为秒，%5是为了让t的值在0-5之间循环
        cube.position.x = t * 1;
